...
#endif
#define __METAL_PLIC_SUBINTERRUPTS 274
...
#define __METAL_SERIAL_54000000_INTERRUPTS 1
...
extern struct metal_memory __metal_dt_mem_memory_60000000;
...
extern struct __metal_driver_sifive_uart0 __metal_dt_serial_54000000;
...
{
    if ((uintptr_t)uart == (uintptr_t)&__metal_dt_serial_54000000) {
        return METAL_SIFIVE_UART0_54000000_BASE_ADDRESS;
    }
    else {
        return 0;
    }
...
{
    if ((uintptr_t)uart == (uintptr_t)&__metal_dt_serial_54000000) {
        return METAL_SIFIVE_UART0_54000000_SIZE;
    }
    else {
        return 0;
    }
...
struct metal_memory *__metal_memory_table[] = {
                    &__metal_dt_mem_memory_60000000};

/* From serial@54000000 */
#define __METAL_DT_STDOUT_UART_HANDLE (&__metal_dt_serial_54000000.uart)

#define __METAL_DT_SERIAL_54000000_HANDLE (&__metal_dt_serial_54000000.uart)
